...
const HomePage = () => {
  ...
  const BlogPost = data.map((post) => {
    return (
      ...
      <div className="mb-5">
        <Link to={"/" + post.id}>
          <div className="bg-rose-200  p-8 max-w-5xl text-xl font-semibold space-x-2 rounded shadow-md  ">
            <p className="text-blue-500 font-Viga font-bold text-2xl ">
              #{post.id}. {post.title}
            </p>
            ...
            <div className="flex ">
              ...
              <p className="font-semibold font-Viga mx-6 mt-3">
                {post.desc} <br />
                <button className="bg-blue-900 text-white hover:bg-blue-700 hover:text-white text-sm px-2 py-1 rounded">
                  Read More
                </button>
              </p>
            </div>
            ...
            <div>
              <p className="font-bold mx-4  mt-2 text-sm  "> {post.date} </p>
            </div>
            <div></div>
          </div>
        </Link>
  ...
  return (
    <div>
      ...
      <div className="grid-cols-4 ">riyaz</div>
      ...
      {/* <div className="flex items-center space-x-10">
        ...
        <div>
          <h4 className="text-xl font-semibold">
            Anbu is preparing react js course materials
          </h4>
